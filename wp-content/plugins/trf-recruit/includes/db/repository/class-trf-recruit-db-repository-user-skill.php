<?php
namespace TrfRecruit\Includes\DB\Repository;
 ...
 */
class Trf_Recruit_DB_Repository_User_Skill extends Tru_Fetcher_DB_Repository_Base {

    private Trf_Recruit_DB_Model_User_Skill $userSkillModel;
    private Trf_Recruit_DB_Model_Skill $skillModel;
    public function __construct()
    {
        parent::__construct(new Trf_Recruit_DB_Model_User_Skill());
